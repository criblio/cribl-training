...
function formatFieldName(fieldName) {
  ...
  if (fieldNameExp && fieldName) {
    ...
    return fieldNameExp.evalOn({ name: fieldName });
...
exports.init = (opts) => {
  ...
  fieldNameExp = (conf.fieldNameExpression || '').trim().length ? fieldNameExp = new Expression(conf.fieldNameExpression.trim()) : undefined;
};
